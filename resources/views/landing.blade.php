    ...
    <section id="hero" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="https://placehold.co/1920x500.png?text=AK+Transports+Slider+1" alt="Slider Image 1">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Welcome to AK Transports</h5>
                    <p>Your trusted partner for quality quarry and stone products.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="https://placehold.co/1920x500.png?text=AK+Transports+Slider+2" alt="Slider Image 2">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="https://placehold.co/1920x500.png?text=AK+Transports+Slider+3" alt="Slider Image 3">
                <div class="carousel-caption d-none d-md-block">
    ...
    <section id="about" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2>About Us</h2>
                    <p>AK Transports is a leading provider of high-quality quarry and stone products for the construction industry. We are committed to delivering materials that meet the highest standards, ensuring your projects are built to last. With years of experience and a dedicated team, we provide innovative solutions and exceptional service to our clients.</p>
                </div>
                <div class="col-lg-6">
                    <img src="https://placehold.co/500x300.png?text=About+AK+Transports" alt="About Image" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
